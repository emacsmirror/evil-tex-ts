...
*This is the first release of the package.* While functional, it may contain bugs or rough edges. If you encounter any issues, please [[https://github.com/Prgebish/evil-tex-ts/issues][report them on GitHub]].

If you find *evil-tex-ts* useful, please consider giving it a star on [[https://github.com/Prgebish/evil-tex-ts][GitHub]] — it helps others discover the project!
